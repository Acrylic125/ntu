...
def identical(tree1, tree2):
    if tree1.item != tree2.item:
        return False
    if ((tree1.left == None and tree2.left != None) or 
        (tree1.left != None and tree2.left == None)):
        return False
    if ((tree1.right == None and tree2.right != None) or 
        (tree1.right != None and tree2.right == None)):
        return False
    if tree1.left == None and tree1.right == None:
        assert tree2.left == None and tree2.right == None
        return True
    assert tree2.left != None and tree2.right != None
